...
Then record a decision for each commit below and move the marker.
...
| #1360                                                                | `repo_search_commits` moved to the Search API                | Changes the backend of a working tool and makes it depend on the Search service; worth a separate decision |
