...
// writes reach beyond a single project. At roughly 1.5k tokens for the full
// domain set it costs about 1% of what the tool schemas do (~136k).
//
...
const DOMAIN_GUIDE: readonly (readonly [Domain, string])[] = [
  ...
  [
    Domain.PIPELINES,
    "pipelines_ — builds and YAML pipelines: definitions, folders, runs, logs, timelines, artifacts, tags, work items and changes between builds, retention, resource authorization, project pipeline settings.",
  ],
  ...
  [Domain.GRAPH, "graph_ — identities: users, groups, service principals, memberships."],
