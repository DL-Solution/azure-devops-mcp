...
| Версія      | 3.0.0                                                                                                                                                         |
| Інструменти | 621 у 33 доменах; схеми `/mcp` ≈115k токенів, пресети 24–47k ([deploy/azure/README.md](deploy/azure/README.md#tool-presets-a-smaller-tool-list-per-endpoint)) |
| Тести       | 2329, покриття 92.7 / 85.5 / 97.6 / 94.0                                                                                                                      |
